...
Assistant replies now include direct copy and regenerate actions. Regenerate replaces the most recent assistant response using the existing conversation context. The latest user message can be returned to the composer for editing and resending. Markdown and speech controls remain subsequent chat-polish tasks.
