...
Assistant replies now include direct copy and regenerate actions. Regenerate replaces the most recent assistant response using the existing conversation context. Edit/resend, Markdown and speech controls remain subsequent chat-polish tasks.
